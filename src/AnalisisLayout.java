...
public class AnalisisLayout extends JFrame {
    ...
    private void initUI() {
        ...
        // Kunci utama: kolom 1 & 3 pakai pref (ngepas isi), kolom 2 grow
        JPanel main = new JPanel(new MigLayout(
            "fill, insets 20, gapx 18, gapy 15",
            "[pref!][grow,fill][pref!]",    // <— KOLOM 1 & 3 = pref! (ngepas), KOLOM 2 = grow
            ""
        ));
        ...
        // TIGA KOLOM ATAS — tinggi dipaksa sama dengan sg 3
        main.add(createClientPanel(),       "sg 3, top");           // ngepas isi
        main.add(createInformationPanel(),  "sg 3, growx, top");    // ambil sisa ruang
        main.add(createAdditionalPanel(),   "sg 3, top, wrap");    // ngepas isi

        // Bagian bawah tetap full width
        main.add(createProductListPanel(), "span 3, growx, h 240!, wrap, gaptop 10");
        main.add(createTasksPanel(),       "span 3, growx, h 160!, wrap, gaptop 10");
        main.add(createCommentsPanel(),    "span 3, growx, h 160!, wrap, gaptop 10");

        // Tombol Export - Save - Cancel
        JPanel bottom = new JPanel(new MigLayout("fillx, insets 20 0 10 0", "[grow][]", ""));
        JButton export = new JButton("Export");
        export.setPreferredSize(new Dimension(110, 34));

        JPanel btnRight = new JPanel(new FlowLayout(FlowLayout.RIGHT, 12, 0));
        JButton save = new JButton("Save");
        save.setBackground(new Color(153, 51, 204));
        save.setForeground(Color.WHITE);
        save.setPreferredSize(new Dimension(110, 34));
        JButton cancel = new JButton("Cancel");
        cancel.setPreferredSize(new Dimension(110, 34));
        btnRight.add(save);
        btnRight.add(cancel);

        bottom.add(export, "left");
        bottom.add(btnRight, "right");
        export.addActionListener(e -> onExport());
        save.addActionListener(e -> onSave());
        cancel.addActionListener(e -> onCancel());

        main.add(bottom, "span 3, growx");
    }
    ...
    private JPanel createClientPanel() {
        ...
        // Details button — DIPAKSA TENGAH KOLOM
        JButton details = new JButton("Details");
        details.setPreferredSize(new Dimension(100, 32));
        details.setBackground(new Color(153, 51, 204));
        details.setForeground(Color.WHITE);
        details.setOpaque(true);
        details.setBorderPainted(false);
        details.setFocusPainted(false);
        details.setFont(details.getFont().deriveFont(Font.BOLD));

        // Paksa tombol di tengah kolom (horizontal center) dan beri jarak atas
        contentPanel.add(details, "span 2, align center, gaptop 20");
    ...
    private JPanel createProductListPanel() {
        ...
        String[] cols = {"Renovation","Description","Part #","Qty","List Price","Disc","Price","Wholesale Disc","Wholesale Price"};
        Object[][] rows = {
        ...
        // Atur lebar kolom yang lebih sesuai (lebih compact)
        productTable.getColumnModel().getColumn(0).setPreferredWidth(80);  // Renovation
        productTable.getColumnModel().getColumn(1).setPreferredWidth(150); // Description
        productTable.getColumnModel().getColumn(2).setPreferredWidth(100); // Part #
        productTable.getColumnModel().getColumn(3).setPreferredWidth(50);  // Qty
        productTable.getColumnModel().getColumn(4).setPreferredWidth(90);  // List Price
        productTable.getColumnModel().getColumn(5).setPreferredWidth(50);  // Disc
        productTable.getColumnModel().getColumn(6).setPreferredWidth(90);  // Price
        productTable.getColumnModel().getColumn(7).setPreferredWidth(100); // Wholesale Disc
        productTable.getColumnModel().getColumn(8).setPreferredWidth(100); // Wholesale Price
        
        // Scroll pane untuk tabel product dengan horizontal dan vertical scroll
        JScrollPane sp = new JScrollPane(productTable);
        sp.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        sp.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
        sp.getHorizontalScrollBar().setUnitIncrement(16);
        sp.getVerticalScrollBar().setUnitIncrement(16);
        sp.setPreferredSize(new Dimension(800, 150)); // Pastikan ada ukuran minimum
        
        // Panel untuk scroll pane dan buttons
        JPanel tableContentPanel = new JPanel(new BorderLayout());
        tableContentPanel.add(sp, BorderLayout.CENTER);
        ...
        right.add(Box.createRigidArea(new Dimension(0,6)));
        right.add(del);
        tableContentPanel.add(right, BorderLayout.EAST);
    ...
    private JPanel createTasksPanel() {
        ...
        String[] cols = {"State","Task","Assigner","Executer","Create Date","Est Date","Exec Date"};
        Object[][] rows = {
        ...
        // Atur lebar kolom yang lebih compact
        tasksTable.getColumnModel().getColumn(0).setPreferredWidth(80);   // State
        tasksTable.getColumnModel().getColumn(1).setPreferredWidth(200);  // Task
        tasksTable.getColumnModel().getColumn(2).setPreferredWidth(80);   // Assigner
        tasksTable.getColumnModel().getColumn(3).setPreferredWidth(70);   // Executer
        tasksTable.getColumnModel().getColumn(4).setPreferredWidth(100);  // Create Date
        tasksTable.getColumnModel().getColumn(5).setPreferredWidth(100);  // Est Date
        tasksTable.getColumnModel().getColumn(6).setPreferredWidth(100);  // Exec Date
        
        // Scroll pane untuk tasks dengan horizontal dan vertical scroll
        ...
        p.add(tableContentPanel, BorderLayout.CENTER);
    ...
    private JPanel createCommentsPanel() {
        ...
        // Atur lebar kolom comments
        commentsTable.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        commentsTable.getColumnModel().getColumn(0).setPreferredWidth(120); // Date
        commentsTable.getColumnModel().getColumn(1).setPreferredWidth(80);  // User
        commentsTable.getColumnModel().getColumn(2).setPreferredWidth(500); // Comment
        
        // Scroll pane untuk comments dengan horizontal dan vertical scroll
